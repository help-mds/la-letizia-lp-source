...
import ScrollDrivenLpPage from "./pages/ScrollDrivenLpPage";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/lp/:slug"} component={ScrollDrivenLpPage} />
      <Route path={"/lp-legacy/:slug"} component={InteractiveLpPage} />
